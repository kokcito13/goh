...
!function () {
    ...
    var a = $("#box"), b = "span", c = $("#help p"), d = $("#help_color"), e = {lvT: ["Слепой", "Дальтоник", "Неадекват", "Одноглазий", "Сдепая коза", "Зоркий", "Супер зорький", "Орел", "Бог"], render: function (e, f) {
        ...
        var b = 15 > a ? 0 : Math.ceil((a - 15) / 5), c = this.lvT[b] || _.last(this.lvT), d = c + " уровень " + (a + 1), e = 2 * a;
