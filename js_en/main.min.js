...
!function () {
    ...
    var a = $("#box"), b = "span", c = $("#help p"), d = $("#help_color"), e = {lvT: ["Blind as fuck", "Blind", "Colorblind", "Lunatic", "One eyed", "Watchfull", "Sharp-Sighted", "Hawkeye", "Godlike vision"], render: function (e, f) {
        ...
        var b = 15 > a ? 0 : Math.ceil((a - 15) / 5), c = this.lvT[b] || _.last(this.lvT), d = c + " lvl " + (a + 1), e = 2 * a;
